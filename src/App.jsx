...
function App() {
  return (
    <div className="box-border flex flex-col my-10 bg-fuchsia-100s">
      ...
      <input
        ...
        className="block mx-auto px-4 py-1 w-64 mb-10 bg-white text-base text-pink-400 font-normal mt-1 block w-full px-3 py-2 bg-white border border-pink-200 rounded-md text-sm shadow-sm placeholder-slate-400 focus:outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500"
      />
